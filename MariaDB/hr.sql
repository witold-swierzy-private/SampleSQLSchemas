...
CREATE OR REPLACE INDEX   LOC_CITY_IX  ON   LOCATIONS  ( CITY );
CREATE OR REPLACE INDEX   LOC_COUNTRY_IX  ON   LOCATIONS  ( COUNTRY_ID );
CREATE OR REPLACE INDEX   LOC_STATE_PROVINCE_IX  ON   LOCATIONS  ( STATE_PROVINCE );
...
CREATE OR REPLACE INDEX   DEPT_LOCATION_IX  ON   DEPARTMENTS  ( LOCATION_ID );
...
CREATE OR REPLACE INDEX   EMP_DEPARTMENT_IX  ON   EMPLOYEES  ( DEPARTMENT_ID );
CREATE OR REPLACE INDEX   EMP_JOB_IX  ON   EMPLOYEES  ( JOB_ID );
CREATE OR REPLACE INDEX   EMP_MANAGER_IX  ON   EMPLOYEES  ( MANAGER_ID );
CREATE OR REPLACE INDEX   EMP_NAME_IX  ON   EMPLOYEES  ( LAST_NAME ,  FIRST_NAME );

CREATE OR REPLACE TABLE   JOB_GRADES 
...
CREATE OR REPLACE INDEX   JHIST_DEPARTMENT_IX  ON   JOB_HISTORY  ( DEPARTMENT_ID );
CREATE OR REPLACE INDEX   JHIST_EMPLOYEE_IX  ON   JOB_HISTORY  ( EMPLOYEE_ID );
CREATE OR REPLACE INDEX   JHIST_JOB_IX  ON   JOB_HISTORY  ( JOB_ID );
...
CREATE OR REPLACE SEQUENCE  DEPARTMENTS_SEQ
	INCREMENT BY 10 
	START WITH 280;
...
CREATE OR REPLACE SEQUENCE  LOCATIONS_SEQ   
	INCREMENT BY 100 
	START WITH 3300;